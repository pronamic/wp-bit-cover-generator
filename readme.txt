...
Tags: bit, cover, generator, cpt
Donate link: http://pronamic.eu/donate/?for=wp-plugin-bit-cover-generator&source=wp-plugin-readme-txt
Requires at least: 3.0
Tested up to: 3.4.1
Stable tag: 0.1

Creates an Bit Cover from visitor input.
